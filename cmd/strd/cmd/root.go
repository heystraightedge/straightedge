...
import (
	...
	straightedge "github.com/heystraightedge/straightedge/app"
)

// NewRootCmd creates a new root command for simd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	encodingConfig := straightedge.MakeEncodingConfig()
...
func Execute(rootCmd *cobra.Command) error {
	...
	executor := tmcli.PrepareBaseCmd(rootCmd, "", straightedge.DefaultNodeHome)
...
func initRootCmd(rootCmd *cobra.Command, encodingConfig params.EncodingConfig) {
	...
	rootCmd.AddCommand(
		genutilcli.InitCmd(straightedge.ModuleBasics, straightedge.DefaultNodeHome),
		genutilcli.CollectGenTxsCmd(banktypes.GenesisBalancesIterator{}, straightedge.DefaultNodeHome),
...
func queryCommand() *cobra.Command {
	...
	straightedge.ModuleBasics.AddQueryCommands(cmd)
