...
func NewStraightedgeApp(
	logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool, enabledProposals []wasm.ProposalType,
...
func (app *StraightedgeApp) Name() string { return app.BaseApp.Name() }
...
func (app *StraightedgeApp) BlockedAddrs() map[string]bool {
...
func (app *StraightedgeApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *StraightedgeApp) AppCodec() codec.Marshaler {
	return app.appCodec
}

// InterfaceRegistry returns InterfaceRegistry
func (app *StraightedgeApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *StraightedgeApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *StraightedgeApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *StraightedgeApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *StraightedgeApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *StraightedgeApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *StraightedgeApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *StraightedgeApp) RegisterTendermintService(clientCtx client.Context) {
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(toggleroutertypes.ModuleName).WithKeyTable(toggleroutertypes.ParamKeyTable())
